...
class PDF extends TCPDF
{
   public function Header(){
        ...
        $this->Ln(12); //space
        $this->Cell(189, 3, 'דו"ח טיפולים לרכב',0,1,'C');
...
$pdf->SetTitle('דו"ח טיפולים לרכב');
$pdf->SetSubject('');
$pdf->SetKeywords('');
$pdf->setRTL(true);
...
$pdf->Cell(80,5,'תיאור', 1,0,'C',1);
$pdf->Cell(30,5,'מחיר', 1,0,'C',1);
$pdf->Cell(40,5,'תאריך טיפול', 1,0,'C',1);
...
$totalPrice = 0;
        ...
        {
            $details = $row['fixingDetails'];
            $price = $row['price'];
            $fixDate = $row['fixingDate'];
