...
--
-- Host: 127.0.0.1
-- Generation Time: מאי 26, 2023 בזמן 12:33 PM
...
--
-- מבנה טבלה עבור טבלה `bankaccount`
--

CREATE TABLE `bankaccount` (
  `accountNumber` varchar(128) NOT NULL,
  `branchNumber` varchar(128) NOT NULL,
  `bankName` varchar(128) NOT NULL,
  `owner` varchar(128) NOT NULL,
  `goldNumber` varchar(128) NOT NULL,
  `address` varchar(128) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- הוצאת מידע עבור טבלה `bankaccount`
--

INSERT INTO `bankaccount` (`accountNumber`, `branchNumber`, `bankName`, `owner`, `goldNumber`, `address`) VALUES
('1094176', '906', 'בנק לאומי', 'ג\'בארין אבו רפיק', '150109060000062900053', 'מעלה עירון'),
('10941768', '907', 'בנק מזרחי', 'ג\\\'בארין אבו רפיק', '0109060000062900053', 'הרצליה');
...
INSERT INTO `data_location` (`id`, `descr`, `lat`, `lon`, `projectName`) VALUES
(13, 'רחוב האורגים 27, אשדוד, ישראל', 31.796640, 34.643181, 'פרוגקט פרו בע\"מ '),
(14, 'רחוב שטורמן, הרצליה, ישראל', 32.170139, 34.834648, 'אחווה 6'),
(15, 'שז\"ר 18, הרצליה, ישראל', 32.166965, 34.834435, 'יפתח 10');
...
(19, 'פרוגקט פרו בע״מ', 'רחוב האורגים 27, אשדוד, ישראל', '2021-09-01', '2023-04-29', 'פרוגקט פרו בע״מ', '', 0, 0, 0, 0, 0, 0, 0, 0),
(20, 'אחווה 6', 'רחוב שטורמן, הרצליה, ישראל', '2022-12-05', '2023-04-29', 'עומר שמאי הכהן', '', 0, 0, 0, 0, 0, 0, 0, 1230000),
(21, 'יפתח 10', 'שז\"ר 18, הרצליה, ישראל', '2022-04-29', '2023-04-29', 'ברזילי יוסי וברזילי אלישבע', '', 0, 0, 0, 0, 0, 0, 0, 1070000);
