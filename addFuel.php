                ...
                <div class="navbar-nav w-100" style="float:right;">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="addFuel.php" class="dropdown-item active">דיווח דלק</a>
            ...
            <div class="col-sm-12 custom-form">
                <div class="bg-light rounded p-4 custom-form-container" dir="rtl">
                    ...
                    <form method="post">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="amount" name="amount" placeholder="name@example.com" onchange="myFunction(event)">
                        ...
                        <div class="form-floating mb-3">
                            <input type="date" class="form-control" id="fullDate" name="fullDate" placeholder="">
