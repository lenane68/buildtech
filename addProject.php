                        ...
                        <div class="col-sm-12 col-xl-6">
                            <div class="bg-light rounded h-100 p-4" dir="rtl">
                                ...
                                <form method="post">
                                    ...
                                    <select name="type" class="form-select mb-3" id="id_type" onchange="myFunction(event)" aria-label="Floating label select example" id="type">
                                    ...
                                    <fieldset>
                                        <div id="id_choice_1_container">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="floorsNum" name="floorsNum" placeholder="name@example.com" onchange="myFunction(event)">
                                        ...
                                        <div id="id_choice_2_container" style="display: none">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="floorsNum2" name="floorsNum2" placeholder="name@example.com" onchange="myFunction(event)">
                                                <label for="floorsNum2" class="position-absolute top-0 end-0">מס' קומות</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="roomsNum" name="roomsNum" placeholder="name@example.com" onchange="myFunction(event)">
                                                <label for="roomsNum" class="position-absolute top-0 end-0">מס' חדרים</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="space" name="space" placeholder="name@example.com" onchange="myFunction(event)">
                                                <label for="space" class="position-absolute top-0 end-0">שטחים</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="cup" name="cup" placeholder="name@example.com" onchange="myFunction(event)">
