...
<body>
    <!-- View Fuel Modal -->
    <div class="modal fade" id="fuelViewModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="navbar-nav w-100" >
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <a href="editEmployee.php" class="dropdown-item">עובד</a>
                            ...
                            <a href="editFuel.php" class="dropdown-item active">דיווח בנזין</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                          <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">טבלת דיווחי דלק</h6>
