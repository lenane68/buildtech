...
if(isset($_GET['pdf_report_generate'])) {
    ...
    $select = "SELECT * FROM fuel WHERE carNumber = '$carNumber' AND fullDate >= '$fromDate' ORDER BY fullDate";
...
$totalPrice = 0;
        ...
        $formattedDate = date('d/m/Y', strtotime($fullDate));
