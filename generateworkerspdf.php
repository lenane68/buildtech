...
class PDF extends TCPDF
{
   public function Header(){
        ...
        $this->Ln(12); //space
        $this->Cell(189, 3, 'משכורות עובדים פעילים',0,1,'C');
   ...
   public function Footer(){
        ...
        $this->Cell(5,5,'דו"ח פרטי משכורות עובדים פעילים', 0,0, 'R');
        $this->Cell(50,5,'', 0,0, 'R');
...
$pdf->SetTitle('דו"ח משכורות עובדים פעילים"');
$pdf->SetSubject('');
$pdf->SetKeywords('');
$pdf->setRTL(true);
...
$pdf->Cell(25,5,'שם ', 1,0,'C',1);
$pdf->Cell(20,5,'תפקיד', 1,0,'C',1);
$pdf->Cell(30,5,'תאריך התחלה', 1,0,'C',1);
$pdf->Cell(30,5,'משכורת', 1,0,'C',1);
