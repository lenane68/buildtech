                ...
                <div class="navbar-nav w-100" style="float:right;">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="addmaterial.php" class="dropdown-item active">חומר</a>
        ...
        <div class="content">
            ...
            <div class="col-sm-12 custom-form">
                <div class="bg-light rounded p-4 custom-form-container " dir="rtl">
                    <h6 class="mb-4">הוספת חומר</h6>
                    <form method="post" action="addMaterial.php" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <span class="input-group-text" for="price">.00</span>
                        </div>
                        <div class="form-floating mb-3">
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-select" id="metrics" name="metrics" aria-label="Floating label select example">
                        ...
                        <div class="form-floating mb-3">
                            <div class="row ">
                                ...
                                <input name="img" type="file" class="full-width" />
                            </div>
                        </div>
